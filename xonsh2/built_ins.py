...
from xonsh2.ast import AST
from xonsh2.lazyasd import LazyObject, lazyobject
from xonsh2.inspectors import Inspector
from xonsh2.aliases import Aliases, make_default_aliases
from xonsh2.environ import Env, default_env
...
import xonsh2.procs.specs
import xonsh2.completers.init
...
def subproc_captured_stdout(*cmds, envs=None):
    ...
    """
    return xonsh2.procs.specs.run_subproc(cmds, captured="stdout", envs=envs)
...
def subproc_captured_inject(*cmds, envs=None):
    ...
    or shlex.split().
    """
    o = xonsh2.procs.specs.run_subproc(cmds, captured="object", envs=envs)
    o.end()
    toks = []
    for line in o:
...
def subproc_captured_object(*cmds, envs=None):
    ...
    """
    return xonsh2.procs.specs.run_subproc(cmds, captured="object", envs=envs)
...
def subproc_captured_hiddenobject(*cmds, envs=None):
    ...
    """
    return xonsh2.procs.specs.run_subproc(cmds, captured="hiddenobject", envs=envs)
...
def subproc_uncaptured(*cmds, envs=None):
    ...
    that was produced as a str.
    """
    return xonsh2.procs.specs.run_subproc(cmds, captured=False, envs=envs)
...
class XonshSession:
    ...
    def load(self, execer=None, ctx=None):
        ...
        self.completers = xonsh2.completers.init.default_completers()
