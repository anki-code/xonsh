...
from xonsh2.ply import ply

import xonsh2.wizard as wiz
from xonsh2 import __version__ as XONSH_VERSION
from xonsh2.prompt.base import is_template_string
...
from xonsh2.foreign_shells import CANON_SHELL_NAMES
from xonsh2.xontribs import xontrib_metadata, find_xontrib, xontribs_loaded
...
def _tok_colors(cmap, cols):
    from xonsh2.style_tools import Color
...
def _web(args):
    ...
    subprocess.run([sys.executable, "-m", "xonsh2.webconfig"] + args.orig_args[1:])
