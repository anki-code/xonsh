...
from xonsh2.ply.ply import yacc

from xonsh2 import ast
from xonsh2.ast import has_elts, xonsh_call, load_attribute_chain
from xonsh2.lexer import Lexer, LexToken
from xonsh2.platform import PYTHON_VERSION_INFO
from xonsh2.tokenize import SearchPath, StringPrefix
from xonsh2.lazyasd import LazyObject
from xonsh2.parsers.context_check import check_contexts
...
class BaseParser(object):
    ...
    def __init__(
        self,
        lexer_optimize=True,
        lexer_table="xonsh2.lexer_table",
        yacc_optimize=True,
        yacc_table="xonsh2.parser_table",
        yacc_debug=False,
        outputdir=None,
    ):
        """Parameters
