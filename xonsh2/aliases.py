...
from xonsh2.dirstack import cd, pushd, popd, dirs, _get_cwd
from xonsh2.environ import locate_binary, make_args_env
from xonsh2.foreign_shells import foreign_shell_data
from xonsh2.jobs import jobs, fg, bg, clean_jobs
...
from xonsh2.timings import timeit_alias
from xonsh2.xontribs import xontribs_main
from xonsh2.ast import isexpression

import xonsh2.completers._aliases as xca
import xonsh2.history.main as xhm
import xonsh2.xoreutils.which as xxw
from xonsh2.xoreutils.umask import umask

if ON_POSIX:
    from xonsh2.xoreutils.ulimit import ulimit
...
def xonfig(args, stdin=None):
    ...
    from xonsh2.xonfig import xonfig_main  # lazy import
...
def trace(args, stdin=None, stdout=None, stderr=None, spec=None):
    ...
    from xonsh2.tracer import tracermain  # lazy import
...
def make_default_aliases():
    ...
    if ON_WINDOWS:
        ...
        if not locate_binary("sudo"):
            import xonsh2.winutils as winutils
